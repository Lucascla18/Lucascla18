...
Computer Science student (7th semester) and software developer focused on building modern **Mobile** and **Web** solutions. Currently gaining industry experience in **AI Engineering and Front-end development**, transforming intelligent concepts into production-ready applications.
...
* **Concepts:** AI Integration, MVC, OOP, REST APIs, Scrum, UI/UX.
 ...
 Featured Projects:
* **MedConecta:** Full-stack hybrid telemedicine application built with **Ionic 7 + Angular** and Firebase, featuring secure auth and real-time medical scheduling.
...
Estudante de Ciência da Computação (7º período) e desenvolvedor de software focado em criar soluções **Mobile** e **Web** modernas. Atualmente, ganhando experiência de mercado com **Engenharia de IA e desenvolvimento Front-end**, transformando conceitos inteligentes em aplicações prontas para produção.
...
* **MedConecta:** Aplicativo híbrido full-stack de telemedicina construído com **Ionic 7 + Angular** e Firebase, com autenticação segura e agendamento em tempo real.
